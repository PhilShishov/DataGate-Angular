...
{
    public class SubFundsController : ApiControllerBase
    {
        ...
        public async Task<ActionResult<EntitiesViewModel>> All([FromBody] string userName)
        {
            ...
            if (user != null)
            {
                ...
                model = await EntitiesVMSetup
                    .SetGet<EntitiesViewModel>(this.service, SqlFunctionDictionary.AllActiveSubFund, userColumns);
            }
