...
export class ShareClassesComponent {
  userName: string;
  userRoles = [];
  tableData: IEntitiesViewModel;
  controller: string = 'ShareClasses';
  shareClassesLoaded = false;
  ...
  constructor(
    ...
    private shareClassSevice: ShareClassService,
  ...
  private _fetchData() {
    this.shareClassSevice.all(this.userName).subscribe(data => {
      this.shareClassesLoaded = true;
      this.tableData = data;
  ...
  update(model){
    this.shareClassesLoaded = false;
    model.userName = this.userName;
    this.shareClassSevice.update(model).subscribe(data =>{
      this.shareClassesLoaded = true;
      this.tableData = data;
      this._populateDataSource(data);
    })
  ...
  _getModel(command: string) {
    ...
    model.ControllerName = this.controller;
